...
class exception extends phpObject
{
    ...
    /**
     * "isInstanceOf" checks that the exception is an instance of the given class.
     *
     *    <?php
     *    $this
     *        ->exception(
     ...
     *            }
     *        )
     *            ->isInstanceOf('\RuntimeException')     // passes
     *            ->isInstanceOf('\Exception')            // passes
     *            ->isInstanceOf('\LogicException')       // fails
     *    ;
     *
     * @param string $value
     * @param string $failMessage
